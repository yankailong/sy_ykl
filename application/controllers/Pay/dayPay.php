<?php
class Daypay extends MY_Controller
{
	public function __construct()
	{
		log_message('debug', '=====开始调用Pay->Daypay->__construct接口=====');
		parent::__construct();
		$this->loadLanguageFile('application/controllers/Pay/');
		log_message('debug', '=====调用Pay->Daypay->__construct接口结束=====');
	}
	
	public function showView() {
		$this->load->view('module/Pay/dayPay.htm');
	}
	
	public function getListData() {
		log_message('debug', '=====开始调用Pay->Daypay->getListData接口=====');
		...
		$this->returnJson();
		log_message('debug', '=====调用Pay->Daypay->getListData接口结束=====');
	}
    public function export() {
		log_message('debug', '=====开始调用Pay->Daypay->export接口=====');
		$this->verifyPrivilege();
		...
		log_message('debug', '=====调用Pay->Daypay->export接口结束=====');
	}
}