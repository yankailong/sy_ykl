...
class Reward extends MY_Controller
{
	...
	{
		log_message('debug', '=====开始调用Task->Reward->__construct接口=====');
		parent::__construct();
		$this->loadLanguageFile('application/controllers/Task/');
		log_message('debug', '=====调用Task->Reward->__construct接口结束=====');
	}
	
	public function showView() {
		$this->load->view('module/Task/reward.htm');
	}
	
	public function getListData() {
		log_message('debug', '=====开始调用Task->Reward->getListData接口=====');
		...
		$this->returnJson();
		log_message('debug', '=====调用Task->Reward->getListData接口结束=====');
	}
        public function export() {
		log_message('debug', '=====开始调用Task->Reward->export接口=====');
		$this->verifyPrivilege();
		...
		log_message('debug', '=====调用Task->Reward->export接口结束=====');
	}
}