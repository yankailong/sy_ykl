<?php
class Syzb extends MY_Controller
{
	public function __construct()
	{
		log_message('debug', '=====开始调用Activity->Syzb->__construct接口=====');
		parent::__construct();
		$this->loadLanguageFile('application/controllers/Activity/');
		log_message('debug', '=====调用Activity->Syzb->__construct接口结束=====');
	}
	
	public function showView() {
		$this->load->view('module/Activity/syzb.htm');
	}
	
	public function getListData() {
		log_message('debug', '=====开始调用Activity->Syzb->getListData接口=====');
		...
		$this->returnJson();
		log_message('debug', '=====调用Activity->Syzb->getListData接口结束=====');
	}
        public function export() {
		log_message('debug', '=====开始调用Activity->Syzb->export接口=====');
		$this->verifyPrivilege();
		...
		log_message('debug', '=====调用Activity->Syzb->export接口结束=====');
	}
}