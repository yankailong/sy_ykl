...
class Power extends MY_Controller
{
	...
	{
		log_message('debug', '=====开始调用Task->Power->__construct接口=====');
		parent::__construct();
		$this->loadLanguageFile('application/controllers/Task/');
		log_message('debug', '=====调用Task->Power->__construct接口结束=====');
	}
	
	public function showView() {
		$this->load->view('module/Task/power.htm');
	}
	
	public function getListData() {
		log_message('debug', '=====开始调用Task->Power->getListData接口=====');
		...
		$this->returnJson();
		log_message('debug', '=====调用Task->Power->getListData接口结束=====');
	}
        public function export() {
		log_message('debug', '=====开始调用Task->Power->export接口=====');
		$this->verifyPrivilege();
		...
		log_message('debug', '=====调用Task->Power->export接口结束=====');
	}
}