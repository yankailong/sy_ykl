...
class Transport extends MY_Controller
{
	...
	{
		log_message('debug', '=====开始调用Task->Transport->__construct接口=====');
		parent::__construct();
		$this->loadLanguageFile('application/controllers/Task/');
		log_message('debug', '=====调用Task->Transport->__construct接口结束=====');
	}
	
	public function showView() {
		$this->load->view('module/Task/transport.htm');
	}
	
	public function getListData() {
		log_message('debug', '=====开始调用Task->Transport->getListData接口=====');
		...
		$this->returnJson();
		log_message('debug', '=====调用Task->Transport->getListData接口结束=====');
	}
        public function export() {
		log_message('debug', '=====开始调用Task->Transport->export接口=====');
		$this->verifyPrivilege();
		...
		log_message('debug', '=====调用Task->Transport->export接口结束=====');
	}
}