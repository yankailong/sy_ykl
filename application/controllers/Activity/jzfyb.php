<?php
class Jzfyb extends MY_Controller
{
	public function __construct()
	{
		log_message('debug', '=====开始调用Activity->Jzfyb->__construct接口=====');
		parent::__construct();
		$this->loadLanguageFile('application/controllers/Activity/');
		log_message('debug', '=====调用Activity->Jzfyb->__construct接口结束=====');
	}
	
	public function showView() {
		$this->load->view('module/Activity/jzfyb.htm');
	}
	
	public function getListData() {
		log_message('debug', '=====开始调用Activity->Jzfyb->getListData接口=====');
		...
		$this->returnJson();
		log_message('debug', '=====调用Activity->Jzfyb->getListData接口结束=====');
	}
        public function export() {
		log_message('debug', '=====开始调用Activity->Jzfyb->export接口=====');
		$this->verifyPrivilege();
		...
		log_message('debug', '=====调用Activity->Jzfyb->export接口结束=====');
	}
}