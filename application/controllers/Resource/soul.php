<?php
class Soul extends MY_Controller
{
	public function __construct()
	{
		log_message('debug', '=====开始调用Statistics->Soul->__construct接口=====');
		parent::__construct();
		$this->loadLanguageFile('application/controllers/Statistics/');
		log_message('debug', '=====调用Statistics->Soul->__construct接口结束=====');
	}
	
	public function showView() {
		$this->load->view('module/Statistics/soul.htm');
	}
	
	public function getListData() {
		log_message('debug', '=====开始调用Statistics->Soul->getListData接口=====');
		...
		$this->returnJson();
		log_message('debug', '=====调用Statistics->Soul->getListData接口结束=====');
	}
        public function export() {
		log_message('debug', '=====开始调用Statistics->Soul->export接口=====');
		$this->verifyPrivilege();
		...
		log_message('debug', '=====调用Statistics->Soul->export接口结束=====');
	}
}